import mysql from 'mysql2/promise'; // Se importa para trabajar la dependencia de mysql con promesas
import dotenv from 'dotenv';       // Dependencia que lee valores sensibles
dotenv.config();
...
// ESTO SOLUCIONA LOS SyntaxError EN APP.JS Y RUTAS
export default pool;